   ...
   return Container(
        ...
        child: Card(
          ...
          child: Center(child: Column(
            ...
            children: <Widget>[
              Text(stat,
                style: TextStyle(fontSize: 72, height: 0.80, color: color,)
                )
              ]
            )
          )  
      ...
      body: Container(
        child: ListView(
              children: [
                ...
                Center(child: Text("Confirmed", style: TextStyle(fontSize: 20, height: 2))),
                _buildCard(context, dailyData.deaths.toString(), Colors.red),
                Center(child: Text("Deaths", style: TextStyle(fontSize: 20, height: 2))),
                _buildCard(context, dailyData.recovered.toString(), Colors.green),
                Center(child: Text("Recovered", style: TextStyle(fontSize: 20, height: 2))),
              ]
          ,)
        ,)
      );
